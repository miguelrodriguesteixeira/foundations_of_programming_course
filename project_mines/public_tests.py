...
p1 = cria_parcela()
p2 = limpa_parcela(cria_copia_parcela(p1))
print(not parcelas_iguais(p1, p2))
...
p1 = cria_parcela()
p2 = cria_copia_parcela(p1)
print(alterna_bandeira(esconde_mina(p2)))
...
print(not alterna_bandeira(limpa_parcela(cria_parcela())))
...
m = cria_campo('E',5)
print(obtem_ultima_coluna(m), obtem_ultima_linha(m) == ('E', 5))


m = cria_campo('E',5)
print(campo_para_str(m) == '   ABCDE\n  +-----+\n01|#####|\n02|#####|\n03|#####|\n04|#####|\n05|#####|\n  +-----+')
...
for l in 'AD':limpa_parcela(obtem_parcela(m, cria_coordenada(l,2)))
for l in 'ABCDE':limpa_parcela(obtem_parcela(m, cria_coordenada(l,3)))
print(alterna_bandeira(obtem_parcela(m, cria_coordenada('D',4))))
...
for l in 'ABCDE':limpa_parcela(obtem_parcela(m, cria_coordenada(l,3)))
alterna_bandeira(obtem_parcela(m, cria_coordenada('D',4)))
print(campo_para_str(limpa_campo(m, cria_coordenada('A', 5))) == '   ABCDE\n  +-----+\n01|###2 |\n02|3##2#|\n03|1221 |\n04|   @ |\n05|     |\n  +-----+')
...
c = cria_coordenada('D', 4)
m = coloca_minas(m, c, g, 2)
print(tuple(coordenada_para_str(p) for p in obtem_coordenadas(m, 'minadas')) == ('B01', 'C01'))
...
c = cria_coordenada('D', 4)
m = coloca_minas(m, c, g, 2)
print(campo_para_str(limpa_campo(m, c)) == '   ABCDE\n  +-----+\n01|###1 |\n02|1221 |\n03|     |\n04|     |\n05|     |\n  +-----+')



m = cria_campo('F',6)
print(not jogo_ganho(m))
...
#turno_jogador_mooshak(m, 'L\nG03\n')
ref = '   ABCDEFGHIJKLM\n  +-------------+\n01|####1  1###1 |\n02|11111  113#2 |\n03|         2#2 |\n04|         111 |\n05|             |\n  +-------------+'
print(campo_para_str(m) == ref)

print(minas('Z', 5, 6, 32, 2))
#minas_mooshak('Z', 5, 6, 32, 2, 'M03\nM\nV01\nL\nW01\nL\nX01\nL\nX05\nL\nK01\n')
    
print(minas('Z', 5, 10, 32, 15))
#not minas_mooshak('Z', 5, 10, 32, 15, 'M3\nM03\nM\nC03\nL\nD04\n')